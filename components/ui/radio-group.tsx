...
>(({ className, ...props }, ref) => {
  return (
    <RadioGroupPrimitive.Item
      ...
      {...props}
    >
      <RadioGroupPrimitive.Indicator className="flex items-center justify-center border-green-500">
        <Circle className="h-2 w-2 fill-current text-current text-green-500" />
